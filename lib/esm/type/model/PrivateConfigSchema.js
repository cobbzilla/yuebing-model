...
export const PrivateConfig_autoscanSchema = yup.object(PrivateConfig_autoscanSchemaFields);
export const PrivateConfig_emailSchemaFields = {
...
export const PrivateConfig_emailSchema = yup.object(PrivateConfig_emailSchemaFields);
export const PrivateConfig_authSchemaFields = {
...
export const PrivateConfigSchemaFields = {
    ...
    email: PrivateConfig_emailSchema
        ...
        .when(["emailEnabled"], {
        is: (emailEnabled) => {
            const w = (v) => v.emailEnabled === true;
            const v = { emailEnabled };
            return w(v);
        },
    ...
    autoscan: PrivateConfig_autoscanSchema
        ...
        is: (autoscanEnabled) => {
            const w = (v) => v.autoscanEnabled === true;
            const v = { autoscanEnabled };
            return w(v);
        },
