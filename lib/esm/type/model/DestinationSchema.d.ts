...
export declare const Destination_encryptionSchemaFields: {
...
export declare const Destination_encryptionSchema: yup.ObjectSchema<{
...
export declare const Destination_genericSchemaFields: {
...
export declare const Destination_genericSchema: yup.ObjectSchema<{
    driver: string;
...
export declare const Destination_b2SchemaFields: {
...
export declare const Destination_b2Schema: yup.ObjectSchema<{
    key: string;
    secret: string;
    bucket: string;
...
export declare const Destination_s3SchemaFields: {
    key: yup.StringSchema<string, yup.AnyObject, undefined, "">;
    secret: yup.StringSchema<string, yup.AnyObject, undefined, "">;
    bucket: yup.StringSchema<string, yup.AnyObject, undefined, "">;
...
export declare const Destination_s3Schema: yup.ObjectSchema<{
    key: string;
    secret: string;
    bucket: string;
...
export declare const DestinationSchema: yup.ObjectSchema<{
    name: string;
