...
const genTsType = (typeDef) => generateTypeScriptType(AccountTypeDef, { outfile: `${TS_TYPE_DIR}/${capitalize(typeDef.typeName)}Type.ts` });
...
const GEN_TYPE = "type";
const GEN_ACTIONS = {
    GEN_ALL: (typedef) => genAll(typedef),
    GEN_TYPE: (typedef) => genTsType(typedef),
};
const GEN_TYPES = [
